...
from config import (
    ...
    IMAGES_SAVE_DIR, LOADED_IMAGES_LIMIT, BATCH_LIMIT, 
    DATA_ROOT_FOLDER, LOADED_ARTICLES_LIMIT, TEST_RUN, IMAGE_TO_TEXT_MODEL
)
...
# document_scraper.save_all_article_urls(URLS_FILE_PATH, limit=LOADED_ARTICLES_LIMIT if TEST_RUN else None)
...
if TEST_RUN:
    ...
    image_scraper.scrape_images_from_file(URLS_FILE_PATH, limit=LOADED_IMAGES_LIMIT)
    ...
    image_retrieved_contents, indexed_image_documents = image_captioner.index_images_in_directory(IMAGES_SAVE_DIR, limit=LOADED_IMAGES_LIMIT)
